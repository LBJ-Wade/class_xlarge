...
CCFLAG = -g -fPIC
LDFLAG = -g -fPIC
CCFLAG += -D_DAM_DEBUG -D_DAM_OPTIMIZED_ORDERING
...
SOURCE = input.o background.o thermodynamics.o perturbations.o primordial.o nonlinear.o transfer.o spectra.o lensing.o mpi_stuff.o
